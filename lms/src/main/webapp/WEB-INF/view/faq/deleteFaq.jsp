...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
			...
			<br><br>
			<form method="post" action="${pageContext.request.contextPath}/faq/deleteFaq">
				<table class="table">
					<tr>
					...
					<tr>
						...
						<td>
							<input name="title" type="text" class="form-control" readonly="readonly" placeholder="제목을 입력해주세요">
						</td>
					</tr>
					<tr>
						<th class="text-center" style="vertical-align: middle">내용</th>
						<td>
							<textarea name="content" class="form-control" readonly="readonly" placeholder="Faq 내용을 입력해주세요" cols="50" rows="8"></textarea>
						</td>
					</tr>
				</table>
