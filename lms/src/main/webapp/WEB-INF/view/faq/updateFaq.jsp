        ...
        <div id="layoutSidenav_nav">
      	...
      	<div id="layoutSidenav_content">
			...
			<br>
				...
				<br><br>
				<form method="post" action="${pageContext.request.contextPath}/faq/updateFaq">
					<table class="table">
						<tr>
							<td> 
								<input name="faqNo" type="number" value="${faq.faqNo}" readonly="readonly" class="form-control">
							</td>
						</tr>
						<tr>
							<td> 
						...
						<tr>
							<td>
								<input name="title" id="title" type="text" value="${faq.title}" class="form-control">
								<span id="helpTitle"></span>
							</td>
						</tr>
						<tr>
							<td>
								<textarea name="content"  id="summernote">"${faq.content}"</textarea>
