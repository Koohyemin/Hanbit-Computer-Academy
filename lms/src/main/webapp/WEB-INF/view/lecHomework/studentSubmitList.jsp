		                    ...
		                    <c:forEach var="h" items="${submitList}">
			                    <div class="col-lg-4">
									<table class="table">
										...
										<tr>
											<td>점수</td>
											<td>${h.homeworkScore}<a class="btn btn-outline-primary btn-sm float-end" role="button" href="${pageContext.request.contextPath}/lecHomework/submitOne?homeworkSubmissionNo=${h.homeworkSubmissionNo}&&homeworkMakeTitle=${homeworkMake.homeworkMakeTitle}">상세보기</a></td>
										</tr>
									</table>
								</div>
		                    </c:forEach>
