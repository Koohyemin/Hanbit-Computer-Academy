			...
			<form method="post" id="addNoticeForm" action="${pageContext.request.contextPath}/notice/addNotice">
				<table class="table">
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="revelation" value="F"> 🔒 비공개
						</td> 
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input name="lecQuestionTitle" id="lecQuestionTitle" type="text" class="form-control" placeholder="제목을 입력해주세요">
					...
					<tr>
						...
						<td>
							<textarea name="lecQuestionContent" id="summernote"></textarea>
