			...
			<div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        수료 증명서
                        <input type="button" id="btnPrint" value="수료증명서 출력하기" class="btn btn-dark btn-sm float-end">
                    </div>
                    <div class="card-body">
						<!-- 학생의 납입 리스트  -->
		               <table class="table">
		                   ...
		                   <tbody>
		                   	<c:forEach var="m" items="${selectCompletionList}">
									<tr>
										<td>${m.studentName}</td>
										<td>${m.subjectName}</td>
										<td>${m.lectureName}</td>
			               ...
			               <table style="width:100%;border:1px solid #000000;">
			                   <thead>
			                       <tr>
			                           <th style="border:1px solid #000000;">이름</th>
			                           <th style="border:1px solid #000000;">과목</th>
			                           <th style="border:1px solid #000000;">강좌이름</th>
			                           <th style="border:1px solid #000000;">개강일</th>
			                           <th style="border:1px solid #000000;">종강일</th>
			                       </tr>
			                   </thead>
			                   <tbody>
			                   <c:forEach var="m" items="${selectCompletionList}">
									<tr>
										...
										<td style="border:1px solid #000000;">${m.subjectName}</td>
										<td style="border:1px solid #000000;">${m.lectureName}</td>
										<td style="border:1px solid #000000;">${m.beginClass}</td>
										<td style="border:1px solid #000000;">${m.endClass}</td>
									</tr>
									</c:forEach>
			                   </tbody>
		              		 </table>
