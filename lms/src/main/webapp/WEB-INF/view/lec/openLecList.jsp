		...
		<div class="container-fluid px-4">
     	<!-- 컨텐츠 삽입 부분-->
			...
			<ul class="nav nav-tabs">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="${pageContext.request.contextPath}/lec/openLecList">개설 강좌</a>
					</li>
				...
				<tbody>
					<c:forEach var="lec" items="${list}" varStatus="status">
						<tr>
							...
							<td class="text-center col-md-4" ><a href="${pageContext.request.contextPath}/lec/lecOne?lectureName=${lec.lectureName}" class="none-unline text-dark"><b>${lec.lectureName}</b></a></td>
							<td class="text-center"><b class="text-primary">${lec.registrationCount}</b>/${lec.registrationNumber}</td>
							<td class="text-center">${lec.beginClass}-${lec.endClass}</td>
							<td id="point">
