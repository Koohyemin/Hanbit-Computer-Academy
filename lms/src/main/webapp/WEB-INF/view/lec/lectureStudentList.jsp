       ...
       <div id="layoutSidenav_content">
			...
			<br>
	                <div class="card mb-4">
	                    ...
	                    <div class="card-body">
							<!-- LecNotice 목록 리스트  -->
						<form method="get" action="${pageContext.request.contextPath}/lec/lectureStudentList">
				        ...
				        <br>
				        <c:if test="${fn:length(selectLecStudentList) == 0}">
				        <div class="card mb-4">
		                    <div class="card-header">
		                   		학생조회결과
		                    </div>
				         ...
				         <c:if test="${fn:length(selectLecStudentList)!= 0}">
				          <div class="row">
				       		<c:forEach var="s" items="${selectLecStudentList}">
					        	 ...
					        	 <div class="card mb-4">
					                    <div class="card-header">
					                   	<b> ${s.studentName} </b>학생
					                    </div>
					                    <div class="card-body">
					                    <table class="table">
								        	<tr>
								        	<td>생일</td><td>${s.studentBirth}</td>
								        	</tr>
								        	<tr>
