...
import lombok.extern.slf4j.Slf4j;
	...
	@WebFilter(value = { "/certificate/*", "/faq/*", "/notice/*", "/questionnaire/*", "/lecQna/*", "/teacher/*", "/student/*", "/people/*"
			, "/index", "/lec/*" ,"/member/*" , "/enquiryBoard/*" , "/home/*" , "/lectureNotice/*","/lecHomework/*","/subject/*"})
