...
public class LectureNoticeController {
	...
	// 공지사항 등록(폼)
		...
		public String getInsertLectureNotice(Model model
			...
			List<LecPlan> lectureNameList = lectureNoticeService.getInsertLectureNotice(teacherId);
	...
	// 공지사항 삭제
		...
		public String getUpdateLectureNotice(Model model, @RequestParam(name="lecNoticeNo") int lecNoticeNo) {
